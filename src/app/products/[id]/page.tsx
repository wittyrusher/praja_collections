    ...
    >
      ...
      <div className="bg-white border-b border-stone-200">
        <div className="container mx-auto px-4 py-3">
          <button
            onClick={() => router.back()}
            className="flex items-center gap-1.5 text-stone-500 hover:text-stone-900 text-sm font-medium transition-colors duration-150"
          >
          ...
          <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-8 space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className={`text-sm font-semibold ${product.stock <= 5 ? 'text-red-500' : 'text-stone-500'}`}>
            ...
            <div className="flex gap-3 pt-2">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-4 bg-amber-500 hover:bg-amber-400 disabled:bg-stone-200 disabled:text-stone-400 disabled:cursor-not-allowed text-stone-900 font-bold text-base rounded-xl transition-colors duration-200 shadow-md"
              >
